...
*Credit/Author*
_Made by :_ *Degs*(ytta)
_Partner/helper :_ *ChatGpt 4.0*
...
_${prefix}tagall <text>_ *- mention all member*

*_~🚧 AI Feature~_*
_${prefix}ask <tanya>_ *- chat dengan ai Gemini*
_${prefix}facehd_ *- Face enhancers*
_${prefix}hdin <tipe>_ *- Photo upscale*
_${prefix}mstick <kata>_ *- Sticker kata kata*
_${prefix}removebg_ *- Backround Remover*

*_~🚧 BMKG Information~_*
_${prefix}infogempa_ *- info gempa terbaru*
_${prefix}gempaterkini_ *- info gempa*
_${prefix}cuaca <lokasi>_ *- info cuaca*

*_~🚧 Game Feature~_*
_${prefix}listgame_ *- game list*
_${prefix}susunkata_ *- game Susun kata*
_${prefix}tebakgambar_ *- tebak gambar*
_${prefix}ramalcinta <nama1> <nama2>_ *- love meter*

*_~🚧 Downloader Feature~_*
_${prefix}get tt <link>_ *- Tiktok downloader*
_${prefix}get ig <link>_ *- Instagram downloader*

*_~🚧 Reminder Feature~_*
_${prefix}sholatreminder_ *- adding sholat reminder*
_${prefix}remsholatreminder_ *- remove sholat reminder*
